...
export class SuppliersMapComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.paramsSubscription = this.route.params.subscribe((params: Params) => {
        ...
        this.updateChart(this.report_params.year, this.report_params.id)
      }
    );
  }
  ...
  updateChart(year: number, id: number) {
    let company_name = ''
    if (id != 0) {
      company_name = "~" + id;
    }
    embed("div#supplier-map", {
      ...
      "data": [
        ...
        {
          "name": "suppliers",
          "url": "https://wikirate.org/Commons+Supplier_of+Answer.json?filter[not_ids]=&filter[company_name]=" + company_name + "&filter[year]=" + year + "&filter[company_group][]=Supplier%20of%20Apparel%20100&limit=0&view=answer_list",
